...
(function () {
  ...
  overlay.innerHTML = [
    '<div style="background:#FFF8F3;border-radius:20px;max-width:560px;width:100%;padding:40px 36px;box-shadow:0 24px 72px rgba(0,0,0,0.4);max-height:90vh;overflow-y:auto;">',
      ...
      '<p style="font-size:14px;line-height:1.6;color:rgba(10,37,64,0.75);margin-bottom:20px;">Lo que vas a ver incluye estrategia de producto, modelo de negocio, integraciones con socios y proyecciones financieras de Shelfly. Es informacion propietaria y no esta destinada a circulacion publica.</p>',
      ...
      '<div style="background:white;border:1px solid rgba(10,37,64,0.1);border-radius:12px;padding:16px 18px;margin-bottom:24px;">',
        ...
        '<p style="font-size:13px;line-height:1.55;color:rgba(10,37,64,0.8);margin:0 0 8px;">Al continuar te comprometes a:</p>',
        '<ul style="font-size:13px;line-height:1.55;color:rgba(10,37,64,0.8);margin:0;padding-left:18px;">',
          '<li>Mantener esta informacion como confidencial.</li>',
          '<li>No compartir, reproducir ni difundir el contenido sin autorizacion escrita de Pedro Rojas Campuzano.</li>',
          '<li>Usarla solo para evaluar una posible colaboracion, inversion o relacion comercial con el proyecto.</li>',
          '<li>Aceptar que tu firma y acceso quedan registrados como evidencia del acuerdo.</li>',
        '</ul>',
      '</div>',
